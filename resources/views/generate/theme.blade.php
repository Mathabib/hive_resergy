...
<main class="app-main">
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    saveBtn.addEventListener('click', async () => {
      const data = {
        sidebar_color: document.querySelector('#sidebar-color').value,
        sidebar_theme: document.querySelector('#sidebar-color-modes').value,
        navbar_color: document.querySelector('#navbar-color').value,
        navbar_theme: document.querySelector('#navbar-color-modes').value,
        footer_color: document.querySelector('#footer-color').value,
        footer_theme: document.querySelector('#footer-color-modes').value,
      };
